...
Validate the predicted forage quality parameters with wet chemsity. If machine is underestimating ADF and NDF, this will explain the high RFV values. The NDFD values need to also be validated. We need to consult with a lab familiar with NIRS for both conventional and reduced lignin alfalfa. 
